...
project_title <- c("Build Innovate Make an impact")
project_year <- c(2019)
...
```{r}
Promoter_part <- c("BBa_R0010", "BBa_R0010")
Host <- c("E. coli", "S. thyphimurium")
Inducer <- c("IPTG", "IPTG")
Reporter_gene <- c("RFP", "RFP")
Promoter_result <- data.frame(Promoter_part, 
                        Host, 
                        Inducer, 
                        Reporter_gene)
#knitr::kable(std, format = "markdown")
knitr::kable(Promoter_result)
